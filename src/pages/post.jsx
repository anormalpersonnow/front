...
export const PostPage = (props) => {
    ...
    const [user, comments, setComments, textArea, setTextArea] = props.content
    const pagePost = props.posts.find(post => post.id.slice(0, 8) === props.url)
    ...
    return (
        < div className="flex flex-col justify-center align-center pb-[4vh]">
            ...
            <div className="flex flex-col align-center relative left-[5vw] mt-[4vh] w-[100vw] justify-center">
                <SinglePost
                    pagePost={pagePost}
                    role={user.role}
                    userId={user.Id}
